...
import { updateProfileController ,updateDriverVerificationController,getDriversController,getUserByIdController, dashboardController} from "../controller/user.js";
...
router.route("/data").get(dashboardController);
